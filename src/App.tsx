...
function convertToStandardFields(input: any): any {
    ...
    const newObject = {
        ...
        "data": {
            ...
            "scenario": input?.scenario ?? input?.data?.scenario ?? input?.defaultScenario ?? input?.data?.defaultScenario ?? "",
            "creator_notes": input?.creator_notes ?? input?.data?.creator_notes ?? input?.description ?? input?.data?.description ?? "Creator notes go here.",
            ...
            "alternate_greetings": input?.alternate_greetings ?? input?.data?.alternate_greetings ?? [],
